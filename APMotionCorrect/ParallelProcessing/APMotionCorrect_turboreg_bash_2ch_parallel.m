if exist('filelist')
    ...
    parfor filenum = 1:length(filelist)
        ...
        savename = [savedir filesep filename_file '_Turboreg_ch' num2str(channel_correct)];
...
%         javaaddpath([javafolder])        
        ...
        Turboreg_AP_pro_2ch_parallel(im_t,filename,savename,channels,channel_correct);

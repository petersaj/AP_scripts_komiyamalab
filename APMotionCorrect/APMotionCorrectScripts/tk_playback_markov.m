function [fixeddata,countdata]=tk_playback_markov(fullfilename,offsets,edgebuffer,playback,totvel)
...
savefile = [filepath filesep 'HMM_' filename '.tif'];
...
for i=frames
    ...
    imwrite(im,savefile,'tif','Compression','none','WriteMode','append');

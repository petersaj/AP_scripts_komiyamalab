function split_createPI(filename,savedir,maxdx,maxdy,numchannels)
...
save([savedir filesep filebase '_PI.mat']);
waitbar(1,h,'Done!');
if exist('h') delete(h); end

...
% APMOTIONCORRECT_PAR MATLAB code for APMotionCorrect_par.fig
%      APMOTIONCORRECT_PAR, by itself, creates a new APMOTIONCORRECT_PAR or raises the existing
%      singleton*.
%
%      H = APMOTIONCORRECT_PAR returns the handle to a new APMOTIONCORRECT_PAR or the handle to
%      the existing singleton*.
%
%      APMOTIONCORRECT_PAR('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in APMOTIONCORRECT_PAR.M with the given input arguments.
%
%      APMOTIONCORRECT_PAR('Property','Value',...) creates a new APMOTIONCORRECT_PAR or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before APMotionCorrect_par_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to APMotionCorrect_par_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help APMotionCorrect_par

% Last Modified by GUIDE v2.5 25-Apr-2011 17:15:33

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @APMotionCorrect_par_OpeningFcn, ...
    'gui_OutputFcn',  @APMotionCorrect_par_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before APMotionCorrect_par is made visible.
function APMotionCorrect_par_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to APMotionCorrect_par (see VARARGIN)

% Choose default command line output for APMotionCorrect_par
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes APMotionCorrect_par wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = APMotionCorrect_par_OutputFcn(hObject, eventdata, handles)

function AP_label_offscreen_rois(animal)
...
local_save_filename = [roi_path filesep animal '_offscreen.roilabel'];
server_save_filename = ['Z:\People\Andy\Data\' animal filesep animal ...
    '_batch_thresh_roi' filesep animal '_offscreen.roilabel'];

save(local_save_filename,'roi_labels');
save(server_save_filename,'roi_labels');

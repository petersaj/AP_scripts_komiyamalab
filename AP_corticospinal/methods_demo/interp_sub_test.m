...
a = zeros(50,100,100);
t1 = sin(linspace(0,3*pi,100))+1;
t2 = sin(linspace(0,3*pi,100)+pi/2)+1;
t2(1:34) = 0;
...
% Get non-interpolated for demo purposes
b_pre = a2;
b_pre(repmat(sum(rois,3) > 0,1,1,size(b,3))) = NaN;
...
% Save movies
save_dir = 'Z:\People\Andy\Corticospinal\methods_demo';
